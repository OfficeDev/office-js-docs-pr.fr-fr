...
- L’événement [initialize](../../reference/shared/office.initialize.md) de l’objet **Office**, qui est déclenché lors de l’initialisation du contexte complément et donne accès à une instance de l’objet [Document](http://dev.office.com/reference/add-ins/shared/document), qui représente le document avec lequel complément interagit.
