...
Par exemple, le seul contenu que nous devaient conserver à partir du styles.xml pour l’exemple de texte de la figure 2, qui est mise en forme à l’aide du style Heading 1, est le suivant :
