...
- Pour Outlook sur Windows :
  ...
  - Configurez le Registre :
    ...
    1. Ajoutez une entrée nommée `EnableBetaAPIsInJavaScript` et définissez la valeur sur `1` .
