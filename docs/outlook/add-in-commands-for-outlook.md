...
> [!NOTE]
> Les commandes de complément sont disponibles uniquement dans Outlook 2013 ou une version ultérieure sur Windows, Outlook 2016 ou une version ultérieure sur Mac, Outlook sur iPhone, Outlook sur Android, Outlook sur le web pour Exchange 2016 ou une version ultérieure et Outlook sur le web pour Office 365 et Outlook.com.
>
...
Pour plus d’informations sur la création de commandes de complément, reportez-vous à [Création de commandes de complément dans votre manifeste](../develop/create-addin-commands.md).
...
- [Définir des commandes de complément dans votre manifeste](../develop/create-addin-commands.md)
