...
<span data-ttu-id="7552e-180">Pour gérer la situation sur les Windows :</span><span class="sxs-lookup"><span data-stu-id="7552e-180">To handle the situation on Windows:</span></span>
