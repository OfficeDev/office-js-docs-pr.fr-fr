...
> **REMARQUE** Une fois le schéma manifeste du complément mis à jour vers la version 1.1, vous devez supprimer les éléments **Capabilities** et **Capability**, et les remplacer par les éléments [Hosts](https://dev.office.com/reference/add-ins/manifest/hosts) et [Host](https://dev.office.com/reference/add-ins/manifest/hosts) ou [Requirements et Requirement](specify-office-hosts-and-api-requirements.md).
...
> **REMARQUE** Pour obtenir une copie du fichier XSD (définition du schéma XML) pour le manifeste de complément version 1.1, consultez les [informations de référence sur le schéma des manifestes des compléments Office (version 1.1)](../develop/add-in-manifests.md).
