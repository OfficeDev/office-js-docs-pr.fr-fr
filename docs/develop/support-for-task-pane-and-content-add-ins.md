...
2.  **l'Objet du Document** La majorité de l'API disponible pour les compléments de volet de contenu et de tâche est exposée via les méthodes, propriétés et événements de [Document](https://dev.office.com/reference/add-ins/shared/document) objet. Un complément de volet de contenu ou de tâche peut utiliser le [Bureau.contexte.document](https://dev.office.com/reference/add-ins/shared/office.context.document) propriété pour accéder au **Document** objet, et à travers elle, peut accéder aux membres clés de l'API pour travailler avec des données dans des documents, tels que les [Liaisons](https://dev.office.com/reference/add-ins/shared/bindings.bindings) et [CustomXmlParts](https://dev.office.com/reference/add-ins/shared/customxmlparts.customxmlparts) objets, et le [getSelectedDataAsync](https://dev.office.com/reference/add-ins/shared/document.getselecteddataasync), [setSelectedDataAsync](https://dev.office.com/reference/add-ins/shared/document.setselecteddataasync), et [getFileAsync](https://dev.office.com/reference/add-ins/shared/document.getfileasync) méthodes le **Document** objet fournit également le [mode](https://dev.office.com/reference/add-ins/shared/document.mode) propriété pour déterminer si un document est en lecture seule ou en mode édition, l' [url](https://dev.office.com/reference/add-ins/shared/document.url) propriété pour obtenir l'URL du document en cours, et l'accès à [Paramètres](https://dev.office.com/reference/add-ins/shared/settings) objet. le **Document** objet prend également en charge l'ajout de gestionnaires d'événements pour la [Selection modifiée](https://dev.office.com/reference/add-ins/shared/document.selectionchanged.event) événement, de sorte que vous pouvez détecter lorsqu'un utilisateur modifie sa sélection dans le document.
