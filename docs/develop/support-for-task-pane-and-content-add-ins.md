...
Pour obtenir un résumé de Office prise en charge de l’API JavaScript sur Office applications clientes, consultez [Présentation de l’API JavaScript Office](understanding-the-javascript-api-for-office.md).
