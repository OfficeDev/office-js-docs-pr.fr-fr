...
- La [fonction messageParent](/javascript/api/office/office.ui#messageparent-message-) doit généralement être appelée à partir d’une page dans le même domaine que le module lui-même, mais cela n’est pas obligatoire. Pour plus d’informations, consultez la messagerie entre domaines [à l’runtime hôte.](dialog-api-in-office-add-ins.md#cross-domain-messaging-to-the-host-runtime)
