...
3. <span data-ttu-id="fd3d1-120">Nommez votre projet et sélectionnez **Créer**.</span><span class="sxs-lookup"><span data-stu-id="fd3d1-120">Name your project and select **Create**.</span></span>
