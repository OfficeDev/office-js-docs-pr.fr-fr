...
- Offrez des [essais gratuits](https://docs.microsoft.com/fr-fr/office/dev/store/decide-on-a-pricing-model#office-store-pricing-options). Si votre complément nécessite un abonnement, proposez certaines fonctionnalités gratuitement.
...
- Utilisez l’[authentification unique (SSO)](https://docs.microsoft.com/fr-fr/outlook/add-ins/authenticate-a-user-with-an-identity-token).
...
- Utilisez un [langage clair et simple](../design/add-in-design-guidelines.md#voice-guidelines) dans votre complément.

- Soulignez l’[accessibilité](../design/ui-elements/accessibility-guidelines.md) : votre complément doit être facile à utiliser pour tous les utilisateurs et s’accommoder de technologies d’assistance telles que les lecteurs d’écran.
...
- Publiez votre complément dans [AppSource](https://docs.microsoft.com/fr-fr/office/dev/store/submit-to-the-office-store) et [faites sa promotion](https://docs.microsoft.com/fr-fr/office/dev/store/promote-your-office-store-solution) sur votre site web. Créez un [référencement AppSource efficace](https://docs.microsoft.com/fr-fr/office/dev/store/create-effective-office-store-listings).
