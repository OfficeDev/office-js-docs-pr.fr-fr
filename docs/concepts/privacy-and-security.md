...
- 
  [Présentation des autorisations de complément Outlook](https://docs.microsoft.com/fr-fr/outlook/add-ins/understanding-outlook-add-in-permissions)
