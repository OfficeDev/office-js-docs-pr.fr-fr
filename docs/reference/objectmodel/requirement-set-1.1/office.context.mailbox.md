...
|Nom| Type| Description|
|---|---|---|
|`input`| [LocalClientTime](/javascript/api/outlook_1_1/office.LocalClientTime)|La valeur de l'heure locale à convertir.|
...
|Nom| Type| Description|
|---|---|---|
|`itemId`| String|L'identificateur des services web Exchange pour un message existant.|
...
Avec la méthode `makeEwsRequestAsync` , vous ne pouvez pas demander des Eléments Associés à un Dossier.
