...
---
# <a name="office-mailbox-requirement-set-11"></a>Office (boîte aux lettres requise définie sur 1,1)
...
|---|---|---|:---:|
| [context](office.context.md) | Composition<br>Read | [Context](/javascript/api/office/office.context?view=outlook-js-1.1) | [1.1](../requirement-set-1.1/outlook-requirement-set-1.1.md) |
...
[MailboxEnums](/javascript/api/outlook/office.mailboxenums.attachmentcontentformat?view=outlook-js-1.1): inclut un certain nombre d’énumérations propres à Outlook, par exemple,,,,, `ItemType` `EntityType` `AttachmentType` `RecipientType` `ResponseType` et `ItemNotificationMessageType` .
