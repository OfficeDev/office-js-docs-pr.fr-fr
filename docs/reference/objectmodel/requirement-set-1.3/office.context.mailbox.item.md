...
#### <a name="attachments-arrayattachmentdetailsjavascriptapioutlook13officeattachmentdetails"></a>pièces jointes: tableau. <[AttachmentDetails](/javascript/api/outlook_1_3/office.attachmentdetails)>
...
#### <a name="bcc-recipientsjavascriptapioutlook13officerecipients"></a>CCI: [destinataires](/javascript/api/outlook_1_3/office.recipients)
...
#### <a name="cc-arrayemailaddressdetailsjavascriptapioutlook13officeemailaddressdetailsrecipientsjavascriptapioutlook13officerecipients"></a>CC: Array. <[EmailAddressDetails](/javascript/api/outlook_1_3/office.emailaddressdetails)>|[destinataires](/javascript/api/outlook_1_3/office.recipients)
...
#### <a name="end-datetimejavascriptapioutlook13officetime"></a>fin: date | [Fois](/javascript/api/outlook_1_3/office.time)
...
L’exemple suivant définit l’heure de fin d’un rendez-vous en utilisant la méthode [`setAsync`](/javascript/api/outlook_1_3/office.time#setasync-datetime--options--callback-) de l’objet `Time`.
...
#### <a name="from-emailaddressdetailsjavascriptapioutlook13officeemailaddressdetails"></a>de: [EmailAddressDetails](/javascript/api/outlook_1_3/office.emailaddressdetails)
...
#### <a name="location-stringlocationjavascriptapioutlook13officelocation"></a>Location: String | [Emplacement](/javascript/api/outlook_1_3/office.location)
...
#### <a name="organizer-emailaddressdetailsjavascriptapioutlook13officeemailaddressdetails"></a>Organisateur: [EmailAddressDetails](/javascript/api/outlook_1_3/office.emailaddressdetails)
...
#### <a name="sender-emailaddressdetailsjavascriptapioutlook13officeemailaddressdetails"></a>expéditeur: [EmailAddressDetails](/javascript/api/outlook_1_3/office.emailaddressdetails)
...
#### <a name="start-datetimejavascriptapioutlook13officetime"></a>début: date | [Fois](/javascript/api/outlook_1_3/office.time)
...
#### <a name="subject-stringsubjectjavascriptapioutlook13officesubject"></a>Subject: String | [Objet](/javascript/api/outlook_1_3/office.subject)
