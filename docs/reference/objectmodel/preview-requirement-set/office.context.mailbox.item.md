...
| | | [Participant à un rendez-vous](/javascript/api/outlook/office.appointmentread?view=outlook-js-preview#isalldayevent) | Booléen | [Aperçu](outlook-requirement-set-preview.md) |
