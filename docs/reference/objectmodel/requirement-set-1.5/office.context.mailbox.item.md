...
*   [Destinataires](/javascript/api/outlook/office.recipients?view=outlook-js-1.5)
...
L’exemple suivant définit l’heure de fin d’un rendez-vous en utilisant la méthode [`setAsync`](/javascript/api/outlook/office.time?view=outlook-js-1.5#setasync-datetime--options--callback-) de l’objet `Time`.
...
L’exemple suivant définit l’heure de début d’un rendez-vous en mode composition à l’aide de la méthode [`setAsync`](/javascript/api/outlook/office.time?view=outlook-js-1.5#setasync-datetime--options--callback-) de l’objet `Time`.
...
Type : [Entities](/javascript/api/outlook/office.entities?view=outlook-js-1.5)
...
|---|---|---|
|`entityType`| [Office.MailboxEnums.EntityType](/javascript/api/outlook/office.mailboxenums.entitytype?view=outlook-js-1.5)|Une des valeurs d’énumération EntityType.|
