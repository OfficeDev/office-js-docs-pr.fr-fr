...
#### <a name="attachments-arrayattachmentdetailsjavascriptapioutlook17officeattachmentdetails"></a>pièces jointes: tableau. <[AttachmentDetails](/javascript/api/outlook_1_7/office.attachmentdetails)>
...
#### <a name="bcc-recipientsjavascriptapioutlook17officerecipients"></a>CCI: [destinataires](/javascript/api/outlook_1_7/office.recipients)
...
#### <a name="cc-arrayemailaddressdetailsjavascriptapioutlook17officeemailaddressdetailsrecipientsjavascriptapioutlook17officerecipients"></a>CC: Array. <[EmailAddressDetails](/javascript/api/outlook_1_7/office.emailaddressdetails)>|[destinataires](/javascript/api/outlook_1_7/office.recipients)
...
#### <a name="end-datetimejavascriptapioutlook17officetime"></a>fin: date | [Fois](/javascript/api/outlook_1_7/office.time)
...
L’exemple suivant définit l’heure de fin d’un rendez-vous en utilisant la méthode [`setAsync`](/javascript/api/outlook_1_7/office.time#setasync-datetime--options--callback-) de l’objet `Time`.
...
#### <a name="location-stringlocationjavascriptapioutlook17officelocation"></a>Location: String | [Emplacement](/javascript/api/outlook_1_7/office.location)
...
*   [](/javascript/api/outlook_1_7/office.emailaddressdetails) | [Organisateur](/javascript/api/outlook_1_7/office.organizer) EmailAddressDetails
...
La `recurrence` propriété renvoie un objet [Recurrence](/javascript/api/outlook_1_7/office.recurrence) qui représente la périodicité du rendez-vous. Elle est disponible pour les rendez-vous et les demandes de réunion.
...
La `recurrence` propriété renvoie un objet [Recurrence](/javascript/api/outlook_1_7/office.recurrence) qui fournit des méthodes pour gérer la périodicité des rendez-vous. Elle est disponible pour les rendez-vous.
...
* [Instances](/javascript/api/outlook_1_7/office.recurrence)
...
#### <a name="sender-emailaddressdetailsjavascriptapioutlook17officeemailaddressdetails"></a>expéditeur: [EmailAddressDetails](/javascript/api/outlook_1_7/office.emailaddressdetails)
...
#### <a name="start-datetimejavascriptapioutlook17officetime"></a>début: date | [Fois](/javascript/api/outlook_1_7/office.time)
...
#### <a name="subject-stringsubjectjavascriptapioutlook17officesubject"></a>Subject: String | [Objet](/javascript/api/outlook_1_7/office.subject)
