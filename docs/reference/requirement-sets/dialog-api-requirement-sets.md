...
|  Ensemble de conditions requises  | Office 2013 pour Windows | Office 2016 pour Windows (Installations MSI)   | Office 365 pour Windows (Installations C2R)   |  Office pour iPad  |  Office 365 pour Mac  | Office Online  |  Office Online Server  |
|:-----|-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
L’API de boîte de dialogue version 1.1 est la première version de l’API. Pour plus d’informations sur l’API, consultez la rubrique de référence [API de boîte de dialogue ](/javascript/api/office/office.ui) .
