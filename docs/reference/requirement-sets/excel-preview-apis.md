...
||[spilledColumns](/javascript/api/excel/excel.spillerrorcellvalue#spilledColumns)|Représente le nombre de colonnes qui seraient déversées s’il n’y avait #SPILL ! erreur.|
