...
||[lists](/javascript/api/word/word.body#lists)|Obtient la collection d’objets list dans le corps. En lecture seule.|
...
||[lists](/javascript/api/word/word.contentcontrol#lists)|Obtient la collection d’objets list du contrôle de contenu. En lecture seule.|
...
||[lists](/javascript/api/word/word.range#lists)|Obtient la collection d’objets de liste figurant dans la plage. En lecture seule.|
