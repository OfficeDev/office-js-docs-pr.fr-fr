...
description: Découvrez comment appeler des fonctions de feuille de calcul Excel intégrées telles `VLOOKUP` que `SUM` et à l’aide de l’API JavaScript pour Excel.
ms.date: 12/19/2019
