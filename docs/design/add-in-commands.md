...
- Pour placer vos commandes dans le ruban Office :
    ...
    - N’ajoutez pas de boutons superflus pour augmenter la valeur de votre complément.
     ...
     > [!NOTE]
     > Les compléments qui occupent trop d’espace peuvent ne pas obtenir la [validation d’AppSource](https://docs.microsoft.com/fr-fr/office/dev/store/validation-policies).

- Pour toutes les icônes, suivez les [règles de conception d’icône](design-icons.md).
