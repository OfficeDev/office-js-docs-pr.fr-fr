...
3. Ajoutez le balisage suivant à la note popup.html. :
   - La page comporte un `<input>` dans lequel l’utilisateur entrera son nom, et un bouton qui permet d’envoyer le nom à la page dans le volet Office où il sera affiché.
...
1. Continuez dans le fichier app.js et remplacez `TODO2` par le code suivant. Remarque :
   ...
   - représente l’objet qui agit comme un intermédiaire entre les contextes d’exécution des pages parent et de boîte de dialogue.`result.value`
