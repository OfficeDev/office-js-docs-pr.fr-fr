...
- Pour signaler un problème avec l'API ou la plate-forme Office.js, créez le problème dans le référentiel OfficeDev/office-js (https://github.com/OfficeDev/office-js), que les membres de l'équipe produit surveillent pour les problèmes-client signalés.
